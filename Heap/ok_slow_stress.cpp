...
#include "heap.h"
using namespace std;
bool cmp(pair<int, Heap<int>::Pointer> &a, pair<int, Heap<int>::Pointer> &b){
...
void del(vector<pair<int, Heap<int>::Pointer> > &free_pointers, int ind){
    vector<pair<int, Heap<int>::Pointer> > new_pointers;
...
int main(){
    ...
    vector<pair<int, Heap<int>::Pointer> > free_pointers;
    vector<int> values;
